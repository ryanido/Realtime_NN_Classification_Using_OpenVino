...
from mobilenet_live_put_inference_output import put_inference_output
from mobilenet_live_get_inference_input import get_inference_input
...
def ssdlite_mobilenet_v2_live(device_name='CPU', num_requests=4):

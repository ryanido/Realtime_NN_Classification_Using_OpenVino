...
def put_inference_output(image, inference_output):
  boxes = inference_output['yolonms_layer_1/ExpandDims_1:0'].buffer[0]
  scores = inference_output['yolonms_layer_1/ExpandDims_3:0'].buffer[0]
  indices = inference_output['yolonms_layer_1/concat_2:0'].buffer
